    ...
    <div class="card">
      <div class="card-header">
        <a class="card-link" data-toggle="collapse" href="#collapseOne">
         <i class="fa fa-file-text" aria-hidden="true"></i> Sync Pending List
        </a>
      </div>
      <div id="collapseOne" class="collapse show" data-parent="#accordion">
		...
		<br>
		<c:choose>
		<c:when test="${sync eq 'NO PENDING'}">
			...
			<c:otherwise>
				<table style="width:95%; margin:2%; padding:5%;" class="table table-hover" id="sync-table" align="center">	
							...
							<th><b>LAST DOWNLOAD TIME</b></th>
							<th><b>LAST UPLOAD TIME</b></th>
							</tr>
							
							<c:forEach var="ss" items="${POST_SYNC}">					
							<tr>
							<td> ${ss.pubName}</td>
							<td> ${ss.lastDown}</td>
							<td> ${ss.lastUp}</td>
