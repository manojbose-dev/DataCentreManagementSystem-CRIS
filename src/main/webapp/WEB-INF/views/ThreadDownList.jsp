  ...
  <div id="accordion">
    ...
    <div class="card">
      ...
      <div id="collapseOne" class="collapse show" data-parent="#accordion">
		...
		<br>
		<c:choose>
						<c:when test="${rep_list_down_size ne '0'}">
								<table style="width: 95%; margin: 2%; padding: 5%;"
									...
									<c:forEach var="rld" items="${rep_down_list}">					
									<tr>
									<td style="text-align:left;color:#000; font-size:1em;">${rld.rep_details}</td><td style="text-align:right;"><span style="background-color:#2f6e36; color:#fff; border-radius:50px; padding:5px; font-size:0.8em;">${rld.rep_name}</span></td>
									</tr>
									</c:forEach>
								</table>
							</c:when>
