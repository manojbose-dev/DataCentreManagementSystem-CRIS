  ...
  <div id="accordion">
    ...
    <div class="card">
      ...
      <div id="collapseOne" class="collapse show" data-parent="#accordion">
		...
		<br>
		<c:choose>
						<c:when test="${rep_last_commit_size ne '0'}">
						<h4 align="center" style="background-color:#577e91;color:#FFFFFF; padding:5px;">REPLICATION DATA FROM KMTSN</h4>
								<table style="width: 95%; margin: 2%; padding: 5%;"
									class="table table-hover" id="replica-table" align="center">	
									<tr class="table-danger">
										<th><b>ORIGIN</b></th>
										<th><b>ORIGIN TIME</b></th>
										<th><b>DESTINATION COMMIT TIME</b></th>
									</tr>
									<c:forEach var="rlc" items="${rep_last_commit}">					
									<tr>
									<td style="text-align:center;"><span style="background-color:#2f6e36; color:#fff; border-radius:50px; padding:5px; font-size:0.8em;">${rlc.origin}</span></td>
									<td style="text-align:center;"><span style="background-color:#2f6e36; color:#fff; border-radius:50px; padding:5px; font-size:0.8em;">${rlc.origin_time}</span></td>
									<td style="text-align:center;"><span style="background-color:#2f6e36; color:#fff; border-radius:50px; padding:5px; font-size:0.8em;">${rlc.dest_commit_time}</span></td>
									</tr>
									</c:forEach>
								</table>
							</c:when>
