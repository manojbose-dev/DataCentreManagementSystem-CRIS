  ...
  <div id="accordion">
    ...
    <div class="card">
      ...
      <div id="collapseOne" class="collapse show" data-parent="#accordion">
        ...
        <c:otherwise>
          <table style="width:95%; margin:2%; padding:5%;" class="table table-hover" id="rep-table" align="center">

						<tr class="table-danger">
						<th><b>REPORT TYPE</b></th>
						<th><b>REPORT DATE</b></th>
						<th><b>LOCATION CODE</b></th>
						</tr>
						
						<c:forEach var="rs" items="${REP_STATUS}">					
						<tr>
						<td>${rs.rType}</td>
						<td>${rs.rDate}</td>
						<td>${rs.rLoc}</td>
